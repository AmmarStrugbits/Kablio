...
/*
| Developed by Reskue
| Filename: RecruiterTermsAndConditions.tsx
...
|--------------------------------------------------------------------------
*/
export interface RecruiterTermsAndConditionsProps //extends buttonProps
{
...
|--------------------------------------------------------------------------
*/
const RecruiterTermsAndConditions: React.FC<RecruiterTermsAndConditionsProps> = ({ children }) => {
        ...
        >
            ...
            >
                ...
                <Box>
                    ...
                    <StyledText>
                        These Terms and Conditions (&ldquo;Agreement&ldquo;) govern the use of our
                        ...
                        &ldquo;we&ldquo;, &ldquo;us&ldquo; or &ldquo;our&ldquo;) by recruiters, staffing agencies, and any
                        other entities or individuals representing recruitment services
                        (&ldquo;Recruiters,&ldquo; &ldquo;you,&ldquo; or &ldquo;your&ldquo;). Our company connects candidates
                        (also known as jobseekers), employers, and recruiters. By accessing
                    ...
                    <StyledText>
                        1.1 Eligibility: To be eligible for an Account you must be at least
                        18 years old. You may not use this Website if you previously had an
                        Account terminated or suspended. We reserve the right, in our sole
                        discretion, to accept or reject your registration for an Account.
                        If your registration is accepted by us, you will be allocated an Account.<br />
                        1.2 Account Creation: You may be required to create a user account (&lduo;Account&lduo;)
                        on the Platform. You shall provide accurate, complete, and
                        up-to-date information during the registration process. You are
                        ...
                        person to access your Account. You are responsible for all activities that occur under your Account.<br />
                    ...
                    <StyledText fontWeight={"bold"}>
                        2. Job Postings, Job Assignments and Communication:
                    </StyledText>
                    <StyledText>
                        2.1 Job Postings: You may post job listings on the Platform to
                        attract candidates. You shall provide accurate and complete
                        information in your job postings, including job descriptions,
                        requirements, qualifications, and any other relevant details.<br />
                        2.2 Job Assignments: You may reach out to employers and engage
                        in discussions regarding their job assignments.<br />
                        2.3 Confidential Information: You will not disclose any
                        confidential or sensitive information obtained from employers,
                        except as required by law or with the employer&apos;s explicit consent.<br />
                        2.4 Non-Discrimination: You shall not discriminate against any
                        candidates or Employers based on race, colour, religion, gender,
                        sexual orientation, disability, or any other protected
                        characteristic. All job postings shall comply with relevant
                        equal opportunity laws and regulations.<br />
                        2.5 Communication: You shall engage in professional,
                        respectful, and non-discriminatory communication on the Platform.
                        Harassment, offensive language, or discriminatory behaviour is
                        strictly prohibited.<br />
                        2.6 Outreach to Candidates: By using the Platform, you acknowledge
                        and agree that you may reach out to candidates based on their
                        profiles and job application information. You are solely
                        responsible for evaluating and engaging with candidates at
                        your own discretion.<br />
                        2.7 Outreach to Employers: By using the Platform, you acknowledge
                        and agree that you may reach out to Employers based on their
                        profiles and job assignments. You are solely responsible for
                        evaluating and engaging with employers at your own discretion.
                    </StyledText>
                    ...
                    <StyledText>
                        ...
                        3.2 Prohibited Activities: You shall not use the Platform
                        to post, upload, transmit, or distribute any content that is
                        unlawful, harmful, defamatory, obscene, infringing, or otherwise
                        objectionable. This includes, but is not limited to, content that
                        promotes discrimination, harassment, violence, or illegal
                        activities. You will provide accurate information to employers
                        regarding your services and the candidates you represent.<br />
                        ...
                        of the Treasury&apos;s Office of Foreign Assets Control (&ldquo;OFAC&ldquo;) or
                        any other governmental entity imposing economic sanctions or
                        trade embargoes (&ldquo;Economic Sanctions Laws&ldquo;), or (b) is located,
                        organized, or resident in a country or territory that is,
                        or whose government is, the target of sanctions imposed by
                        OFAC or any other governmental entity. You shall promptly
                        notify us if you or any of your subsidiaries, or any of your
                        or your subsidiaries&apos; directors, officers, managers, employees,
                        or agents becomes the target of any Economic Sanctions Laws,
                        or the country or territory where any of them is located,
                    ...
                    <StyledText>
                        ...
                        for any and all forms of loss or damage arising out of the use
                        of them. You access third-party websites at your own risk. The
                        inclusion of a link to another site on our Website does not imply
                        ...
                        When the product is used as intended, interactions on the Website
                        or App occur between Candidates, Employers and Recruiters. You
                        acknowledge that Kablio is not directly involved in or otherwise
                    ...
                    <StyledText>
                        ...
                        your use of the Platform, violation of these Terms, or infringement
                    ...
                    <StyledText>
                        ...
                        (&ldquo;User Content&ldquo;), to Platform, you grant Kablio a non-exclusive,
                        ...
                        and display such User Content in connection with the operation
                        of the Platform and the Company&apos;s business, including but not
                        limited to promoting and marketing the Platform.<br />
                        ...
                        and that your User Content does not infringe upon or violate
                        the intellectual property rights or any other rights of any third party.
                        We have the right to remove any posting you make on the Website
