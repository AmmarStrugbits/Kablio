            ...
            <TitleContainerBoxStyled>
                <BackgroundBlur>
                    <StepContainerTitleSubtitle style={{}}>
                        <h2>
                            <span> + </span>
                            <span> Create a referral scheme with </span>
                ...
                <SubtitleBoxStyled>
                    <h3 style={{ color: "#505662", padding: "0rem 0.5rem" }}>
                        Konnectors are Kablio jobseekers who can refer other jobseekers
                    </h3>
                </SubtitleBoxStyled>
            </TitleContainerBoxStyled>
            <StepContainerBoxStyled>
                ...
                <StepBox>
                    <Image
                        ...
                        height={matchesMobile ? 30 : 50}
                    />
                    <StepBoxTitle>Activate Konnectors</StepBoxTitle>
                    <StepBoxSubtitle>Opt-in + set your payout amount</StepBoxSubtitle>
