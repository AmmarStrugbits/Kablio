        ...
        <FindRewardsSectionBoxStyled>
            ...
            <TitleContainerBoxStyled>
                <StepContainerTitleSubtitle style={{}}>
                    <h2>
                        <span>
                            ANYBODY with a network can be a Konnector
                        </span>
                    </h2>
            ...
            <StepContainerBoxStyled>
                <StepBox>
                    ...
                    />
                    <StepBoxTitle>Find assignment</StepBoxTitle>
                    <StepBoxSubtitle>Swipe through jobs</StepBoxSubtitle>
                    <Link href='https://at4r1q5j37o.typeform.com/to/CvzQJ2v2' target='_blank' passHref>
                        <LinkBoxStyled>
                            <Box>
                                Pre-register
                            </Box>
                ...
                <StepBox>
                    <Image
                        ...
                        height={matchesMobile ? 30 : 50}
                    />
                    <StepBoxTitle>Share your referral link</StepBoxTitle>
                    <StepBoxSubtitle>Yes, it’s just a link.</StepBoxSubtitle>
                ...
                <StepBox>
                    ...
                    <StepBoxSubtitle>Get paid for successful hires.</StepBoxSubtitle>
