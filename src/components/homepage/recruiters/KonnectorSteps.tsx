...
const KonnectorStepsBoxStyled = styled(Box)(({ theme }) => ({
    position: 'relative',
    padding: "1rem",
...
|--------------------------------------------------------------------------
*/
const KonnectorSteps: React.FC = () => {
    const matchesMobile = useMediaQuery(theme.breakpoints.down('lg'));
    // Render
    //--------------------------------------------------------------------------
    return (
        <KonnectorStepsBoxStyled>
            <ComingSoon />
            <TitleContainerBoxStyled>
                <StepContainerTitleSubtitle style={{}}>
                    <h2>
                        <span>
                            Open up your referral program with Kablio Konnectors
                        </span>
                    </h2>
                </StepContainerTitleSubtitle>
                <SubtitleBoxStyled>
                    <h3>
                        Konnectors are everyday people who refer jobseekers to your jobs
                    </h3>
                </SubtitleBoxStyled>
            </TitleContainerBoxStyled>
            <StepContainerBoxStyled>
                ...
                <StepBox>
                    <Image
                        ...
                        height={matchesMobile ? 30 : 50}
                    />
                    <StepBoxTitle>Set your terms</StepBoxTitle>
                    <StepBoxSubtitle>Set your bonus amount + timing</StepBoxSubtitle>
